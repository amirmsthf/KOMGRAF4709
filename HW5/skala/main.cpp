#include <iostream>
#include <vector> // akses fungsi vektor
...
std::vector<std::vector<double>> scaleMatrix(const std::vector<std::vector<double>>& matrix, double scaleX, double scaleY) { // mengembalikan matriks baru yg merupakan hasil transformasi skala
    std::vector<std::vector<double>> result; // simpan hasil transformasi selama proses iterasi
...
int main() {
    size_t rows, cols; // size_t = tipe data
